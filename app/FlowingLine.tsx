...
const WORD_LIST = [
  // Core AI / Chat
  "AI", "Chatbot", "Prompt", "NPC", "GPT", "Model", "Neural", "Agent", "Dialogue", "Message", 
  "Assistant", "Persona", "Avatar", "Simulation", "Digital", "Synthetic",

  // Storytelling / Roleplay
  "Scenario", "Companion", "Fantasy", "Character", "Conversation", "Drama", "Emotion", "Story",
  "Narrative", "Plot", "Adventure", "Quest", "Journey", "Improv", "Scene", "Lore", "Arc", 
  "Roleplay", "Campaign", "Episode", "Worldbuilding",

  // Feelings / Interaction
  "Trust", "Empathy", "Bond", "Friendship", "Connection", "Imagination", "Dream", "Memory",
  "Curiosity", "Creativity", "Expression", "Identity", "Vibe", "Mood", "Inspiration",

  // Genres / Vibes
  "Sci-Fi", "Cyberpunk", "Myth", "Legend", "Hero", "Villain", "Romance", "Comedy", 
  "Mystery", "Horror", "Thriller", "Magic", "Spell", "Sword", "Realm", "Universe",
  "Galaxy", "Future", "Dystopia", "Utopia",

  // Misc world flavor
  "Echo", "Whisper", "Shadow", "Light", "Flame", "Crystal", "Mirror", "Portal", "Dreamscape",
  "Chronicle", "Saga", "Verse", "Dimension", "Entity", "Oracle", "Prophecy", "Mythos",
];
...
function getRandomTriggerOffset() {
  return 0.05 + Math.random() * 0.20; // 5% – 30%
}
...
export default function FlowingLine({ direction, delay = 0 }: FlowingLineProps) {
...
useEffect(() => {
  ...
  for (let i = 0; i < numWords; i++) {
    ...
    const spacing = baseSpacing + (Math.random() * spacingVariance - spacingVariance / 2);
